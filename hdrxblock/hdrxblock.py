...
class RoverHeaderXBlock(XBlock):
    ...
    hdr_book_icon = String(help="Section textbook icon URL", default="", scope=Scope.content)
    ...
    hdr_playground_icon = String(help="Section playground icon URL", default="", scope=Scope.content)
